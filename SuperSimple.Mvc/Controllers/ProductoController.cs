...
using SuperSimple.Mvc.ViewModels;
...
public class ProductoController : Controller
{
    ...
    public IActionResult Modificar(int id)
    {
        ...
        var vmProducto = new VMProducto(Repositorio.Categorias, producto);
        return View(vmProducto);
    }
    ...
    public IActionResult Modificar(VMProducto vmProducto)
    {
        if (Validar(vmProducto))
        {
            ...
            // Aca tendriamos que tener la actualización del producto en el repositorio
            // recuerden que cambiamos el precio y le agregamos un registro
        }
        return View("Index", Repositorio.Productos);
    }
